            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" id="role_name" v-model="form.role_name"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            placeholder="Role Name">
                        <small v-if="typeof errors.role_name == 'object'" class="text-red-500">
                            {{ errors.role_name[0] }}
                        </small>
                    </div>
                    <div class="mb-6">
                        <label for="message"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Role
                            Description</label>
                        <textarea id="message" rows="4" v-model="form.role_description"
                            class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            placeholder="Role Description"></textarea>
                        <small v-if="typeof errors.role_description == 'object'" class="text-red-500">
                            {{ errors.role_description[0] }}
                        </small>
                    </div>
                </div>
                <!-- Modal footer -->
